...
//		List<MethodTrace> methodtracesNew = InitializePredictionsHashMap2(methodtraces2);
		TraceRefiner traceref= new TraceRefiner(); 
...
//		LogInfoHashMap=InitializeHashMapWithPrecisionRecall(AlgoFinal.methodtraces2HashMap, LogInfoHashMap);
//	
//		
//
//	
...
//	}
	...
	public void ComputeStepResults(PredictionEvaluation step2Pattern2, PredictionValues step2PredictionValues, LinkedHashMap<String, LogInfo> LogInfoHashMap, String ProgramName, String Step, String PredictionValues, PredictionValues step1PredictionValues) throws IOException, SQLException {
		// TODO Auto-generated method stub
		LogInfo.ComputePrecisionAndRecallNONCUMULATIVE(AlgoFinal.methodtraces2HashMap, step2Pattern2, ProgramName, step2PredictionValues, LogInfoHashMap);
	...
	public void ComputeStepResults2(PredictionEvaluation step2Pattern2, PredictionValues step2PredictionValues, LinkedHashMap<String, LogInfo> LogInfoHashMap, String ProgramName, String Step, String PredictionValues, PredictionValues step1PredictionValues) throws IOException, SQLException {
		// TODO Auto-generated method stub
		LogInfo.ComputePrecisionAndRecallCUMULATIVE(AlgoFinal.methodtraces2HashMap, step2Pattern2, ProgramName, step2PredictionValues, LogInfoHashMap);
		System.out.println("RemainingpredictionValues"+TotalPattern);
...
//			myhashmap.put(reqClass, methodtraces2HashMap2.get(mykey).Method.Owner.DeveloperGold);
	...
	/************************************************************************************************************************************************/
	/************************************************************************************************************************************************/
	public LinkedHashMap<String, LogInfo> InitializeHashMapWithPrecisionRecall(
			HashMap<String, MethodTrace> methodtraces2HashMap2, LinkedHashMap<String, LogInfo> logHashMapRemaining) {
		// TODO Auto-generated method stub
